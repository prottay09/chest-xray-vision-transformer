...
class Cross_ViT(pl.LightningModule):
    """Model modified.
    ...
    def __init__(self, out_size):
        ...
        self.cross_vit = CrossViT(num_classes = out_size, image_size=224, sm_dim=192, lg_dim=384)
    ...
    def test_epoch_end(self, test_step_outputs):
        ...
        plt.savefig("CrossViT2_100_scratch.png", dpi=1000)
        plt.show()

        #store the result
        with open("result_100_CrossViT2_scratch_w.json", "w") as outfile:
