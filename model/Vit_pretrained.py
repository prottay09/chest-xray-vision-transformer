...
class pretrained_vit(pl.LightningModule):
    ...
    def __init__(self, out_size):
        ...
        self.vit = ViT("B_16", pretrained=False)
        num_ftrs = self.vit.fc.in_features
    ...
    def test_epoch_end(self, test_step_outputs):
        ...
        plt.savefig("ViT_attn-100B16.png", dpi=1000)
        plt.show()

        #store the result
        with open("result_100_ViT-B16_attn.json", "w") as outfile:
